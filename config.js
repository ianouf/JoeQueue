module.exports = {
  ...
  // i.e: "-joequeue foo" will trigger the command "foo",
  //      whereas "JoeQueue foo" will do nothing at all.
  prefix:  "-joequeue",

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: "MjkyMDE3MTA2MDU5NTI2MTQ0.C6x6GA.09ZdImMPMhmifr-ybBDfbyHxQn4",
